...
if ($['isNode']()) {
    ...
    var _0x3ec279 = {
        ...
        'AzACk': 'http://adguard.b.freefrp.net/cfd.json',
    ...
    if (_0x3ec279['srGVc'](new Date()['getHours'](), 0x3)) _0x4609e7 = await _0x3ec279['HxYbh'](getAuthorShareCode, 'http://adguard.b.freefrp.net/cfd.json');
    if (!_0x3c6afe) _0x3c6afe = await _0x3ec279['HxYbh'](getAuthorShareCode, 'http://adguard.b.freefrp.net/cfd.json');
...
async function helpAuthor3() {
    var _0x1c5e88 = {
        ...
        'CyQkF': 'http://adguard.b.freefrp.net/jd_super.json',
...
function getAuthorShareCode2(_0x2bfabc = 'http://adguard.b.freefrp.net/jd_super.json') {
    var _0xb8d8df = {
        'UeNZP': 'bcQvt',
        'ilEoT': 'IDvth',
        'eLaLE': 'ekCbk',
        ...
        if (_0x6bed88['XoNPb'](_0x6bed88['sSBzL'], _0x6bed88['mvTut'])) {
            ...
            if (_0x13e0a0 && _0x6bed88['XoNPb'](_0x13e0a0['code'], 0xc8)) {
                if (_0x6bed88['eQlcu'](_0x6bed88['ldtZd'], _0x6bed88['ldtZd'])) {
                    ...
                    $['newShareCodes'] = [...new Set([...$['newShareCodes'], ...$['strMyShareIds'], 'F45CB4F07997DFE748E5656521A9034446A1568F6950206B0D44A5664662275D', ..._0x13e0a0['data'] || []])];
                }
            }
...
function requireConfig() {
    var _0x1fa6d8 = {
        ...
        'kRINB': 'false',
        'IxUOn': 'GITHUB',
        'FXaGo': 'F45CB4F07997DFE748E5656521A9034446A1568F6950206B0D44A5664662275D',
